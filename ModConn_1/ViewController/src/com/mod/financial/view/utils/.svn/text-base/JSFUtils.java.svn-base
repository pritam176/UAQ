...
public class JSFUtils {
     ...
     * @return
     */
    public static ValueExpression getValueExpression(String data) {
    ...
    /**
     * Resolve the method as expression.
     * @param expression
     * @param returnType
     * @param argTypes
     * @param argValues
   ...
   */
    ...
    private static ResourceBundle getBundle() {
        ...
        Object o = ctx.getApplication().getMessageBundle();
