...
public class UAQLogger {
	...
	public UAQLogger(final Class clazz) {
	 ...
	 * @param object
	 */
	public void debug(final String message, final String parameter,
			final Object object) {
		if (this.logger.isDebugEnabled()) {
	 ...
	 */
	public void debug(final String message, final String parameter,
			final Object object, final Throwable ex) {
		if (this.logger.isDebugEnabled()) {
	 ...
	 * @param object
	 */
	public void error(final String message, final String parameter,
			final Object object) {
	 ...
	 * @param object
	 */
	public void fatal(final String message, final String parameter,
			final Object object) {
	 ...
	 * @param object
	 */
	public void info(final String message, final String parameter,
			final Object object) {
		if (this.logger.isInfoEnabled()) {
	 ...
	 * @param object
	 */
	public void warn(final String message, final String parameter,
			final Object object) {
