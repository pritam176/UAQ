...
public class PaymentRequestECR implements Serializable {
	...
	public String toString() {
		return "PaymentRequestECR [transactionType=" + transactionType + ", serviceCode=" + serviceCode + ", amount=" + amount + ", ecrIdNo="
				+ ecrIdNo + ", paymentId=" + paymentId + ", merchantId=" + merchantId + ", terminalNo=" + terminalNo + ", statusCode=" + statusCode
				+ ", statusMessage=" + statusMessage + ", paymentInProgress=" + paymentInProgress +"]";
	}


    public void setPaymentInProgress(String paymentInProgress) {
