	...
	<div class="row">
		<div class="col-lg-9 col-sm-9 col-md-9 col-xs-12">
			...
			<div class="breadcrumbs hide-on-mobile">
				...
				<span><i class="glyphicon glyphicon-menu-right"></i></span> <spring:message code="label.department.certificates" />
			...
			<c:set var="subjectValue" value="${certificateVO.title}"/>
			<div class="page-title-mob">
				...
				<h2 class="main-title no-border">${certificateVO.title}</h2>
				<div class="detail-post-content">
					<span class="post-date">${certificateVO.datevalue}</span> <img src="${certificateVO.images[0].genericContentImage}" class="pull-right" alt="">
					<p>${certificateVO.body}</p>
					<p>${certificateVO.author}</p>
				</div>
			</div>
			<!-- Page Content End -->
			<!-- Back Button Start -->
...
<script type = "text/javascript">
	...
	var logo = '${logo}';
	var sub_value = '${certificateVO.title}';
