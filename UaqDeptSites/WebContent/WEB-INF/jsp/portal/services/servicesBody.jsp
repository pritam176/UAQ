				...
				<div class="page-content-wrap">
					<div class="content-wrap">
						...
						<c:if test="${not empty serviceVO.serviceFees}">
							...
							<!-- service catalogue -->
							<div class="catalogue-section">
								<c:if test="${not empty serviceVO.email or not empty serviceVO.fax or not empty serviceVO.telephone}">
									<h5>
							...
							<div class="row">
								<div class="form-group">
									...
									<c:if test="${(not empty serviceStatus && serviceStatus=='False' && empty serviceLink) ||(serviceStatus=='Coming Soon')}">
										<div class="col-md-12 remove-pad">
