...
<html lang="en">
	...
	<body>
		<div class="container-fluid">
			...
			<div class="mainmenu">
					<div class="col-md-12 hidden-xs hidden-sm">
						<div class="mainmenu-wrap">
							<ul class="no-list cf">
								...
								<li class="active"><a href="#"><spring:message code="label.gccIndividual" /></a>
								</li>
				...
				<c:set var="userName"><spring:message code='plzUserName'/></c:set>
					...
					<c:set var="fullNamereq"><spring:message code = 'plzFullnameBook'/></c:set>
											...
											<div class="row">
												<div class="col-md-12 remove-pad">
				                                            ...
				                                            <div class="col-md-7 form-grp-help">
			                                                    <div class="custom-select-box">
	                                                                <form:select path="countryResidence"  class="required1" name="country" required="required" data-msg-required="${enterCountry}" >
	                                                                    ...
	                                                                    <form:option value="1">United Arab Emirates </form:option>
	                                                               
																	<form:options items="${recidencyList}" />
	                                                                </form:select>
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="countryofcitizen" class="form-lbl mandatory_lbl"><spring:message code="nationality" /></label>
				                                            </div>
				                                            <div class="col-md-7">
			                                                   <div class="custom-select-box">
	                                        ...
	                                        <div class="row">
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="mobile_number1" class="form-lbl mandatory_lbl"><spring:message code="label.mobile1" />
			                                                    </label>
				                                            </div>
				                                            <div class="col-md-7">
															    <div class="col-md-4 col-xs-3 remove-pad">
																	<div class="custom-select-box">
																		<form:select path="mobileCode1"  class="required1" name="countryofcitizen" required="required">
																			<option value="02">002</option>
																			<option value="01">002</option>
																		</form:select>
																	</div> 
																</div>
																<div class="col-md-8 col-xs-9 remove-pad">
																	<form:input path="mobileNumber1" id="mobile_number1" name="mobile_number1" type="number"  class="form-control" placeholder="Phone Number"  required="required" data-msg-required="${valMobile}"/>
																</div>
			                                                </div>
		                                            	</div>
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="mobile_number2" class="form-lbl "><spring:message code="label.mobile2" />
			                                                    </label>
				                                            </div>
				                                            <div class="col-md-7">
																<div class="col-md-4 col-xs-3 remove-pad">
																	<div class="custom-select-box">
																		<form:select path="mobileCode2"  class="required1" name="countryofcitizen" >
																...
																<div class="col-md-8 col-xs-9 remove-pad">
																	<form:input path="mobileNumber2" id="mobile_number2" name="mobile_number2" type="number"  class="form-control" placeholder="Phone Number"  />
																</div>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																 <div class="col-md-4 col-xs-3 remove-pad">
																	<div class="custom-select-box">
																		<form:select path="landLineCode"  class="required1" name="countryofcitizen"  >
																			<option value="02">002</option>
																			<option value="01">002</option>
																		</form:select>
																	</div> 
																...
																<div class="col-md-8 col-xs-9 remove-pad">
																	<form:input path="landLineNumber"  id="landline" name="landline" type="number" class="form-control" placeholder="Land Line Number" required="required" data-msg-required="${enterLandLine}"
																data-rule-maxlength="7" data-rule-minlength="7" data-msg-maxlength="${valMobileLength}"
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="email"  type="email" id="email" name="email" class="form-control" placeholder="Email Address" required="required"  data-msg-required="${emailMsg}"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="userName" id="username" name="username" type="text" class="form-control" placeholder="Username" required="required" data-msg-required="${userName}" />
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <form:input path="password" id="password_register" name="password_register" type="password" class="form-control" placeholder="" required="required" 
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="confirmPassword"  type="password" id="confirm-password" equalto="#password_register" name="confirm-password" class="form-control" placeholder="Confirm Password" required="required"  data-msg-required="${passwordMisMatch}"/>
			                                                </div>
		                                            	</div>
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7 form-grp-help">
																<div class="custom-input">	 <!-- added for help poover  -->
																	<form:input path="fullName" id="fullname" name="fullname" type="text" class="form-control col-md-11" placeholder="Full Name" required="required" data-msg-required="${plzFullNameIndiv}"/> <!-- <span class="form-help" id="popover2">?</span>-->
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <form:input path="emiratesId" id="emaritesid" name="Emaritesid" type="text" class="form-control" placeholder="" required="required" data-msg-required="${enterEmirate}"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="emiratesIdExpDate"  type="date" id="emiratesidexp-password" name="emiratesidexp-password" class="form-control" placeholder="" required="required" data-msg-required="${emirateExpDateMsg}"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <div class="custom-select-box">
	                                                                <form:select path="emirates"  class="required1" name="countryofcitizen" required="required" data-msg-required="${emiratesMsg}" >
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <form:input path="dob" id="dob" name="dob" type="date" class="form-control" placeholder="" required="required" data-msg-required="${dobmsg}" />
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <div class="input-group file-upload">
																	<input type="text" class="form-control" name ="emiratesid-front" readonly required="required" data-msg-required="${emiratesFront}" />
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control" name="emiratesid-back" readonly required="required" data-msg-required="${emiratesBack}" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <form:input path="passportNumber" id="passportnum" name="passportnum" type="text" class="form-control" placeholder="" required="required" data-msg-required="${enterPassportNo}"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control" name ="emiratesid-front" readonly required="required" data-msg-required="${uploadPassport}"/>
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
	    ...
	    <script>
			...
			var imageContryofResidence = '<img src="/img/help/help1.jpg">';
			$('#popoverCountryofResidence').popover({placement: 'right', content: imageContryofResidence, html: true});
			
			var imageFullName = '<img src="/img/help/help1.jpg">';
