							...
							<div class="main-content-wrap">
								...
								<div class="page-content-wrap">
										<div class="form-content cf">
										   <form:form commandName="registrationUaeResidentCommand" name="feedbak" id="feedbak" enctype="multipart/form-data" method="post" action="uaeresidentregister.html" >
										    <div class="row">
												<div class="row"> 
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																...
																<div class="col-md-8 col-xs-9 remove-pad">
																	<form:input path="mobileNumber2" id="mobile_number2" name="mobile_number2" type="text"  class="form-control required"   
																	data-rule-maxlength="7" data-rule-minlength="7" data-msg-required="${valMobile}" data-rule-number="true" data-msg-number="${valMobile}"
																	data-msg-maxlength="${valMobileLength}" 
																	data-msg-minlength="${valMobileLength}" />
																</div>
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																...
																<div class="col-md-8 col-xs-9 remove-pad">
																	<form:input path="LandLineNumber" id="landline" name="landline" type="text" class="form-control" data-rule-number="true" data-msg-number="${enterValidlandlinemsg}"   />
																</div>	
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:password  path="confirmPassword" id="confirm-password" equalto="#password_register" name="confirm-password" class="form-control required"  data-msg-required="${passwordMisMatch}"/>
			                                                </div>
		                                            	</div>
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7 form-grp-help">
																<div class="custom-input">	 <!-- added for help poover  -->
																	<form:input path="fullName" id="fullname" name="fullname" type="text" class="form-control col-md-11 required" data-msg-required="${plzFullNameIndivmsg}" /> <!-- <span class="form-help" id="popover2">?</span>-->
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7 form-grp-help">
			                                                    ...
			                                                    <form:input path="emiratesId" id="emaritesid" name="Emaritesid" type="text" class="form-control required" data-rule-maxlength="15" data-rule-minlength="15"
												...
												<div class="col-md-12 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <div class="input-group file-upload">
																	<input type="text" class="form-control readonly required" readonly="readonly" name ="emiratesid-front" data-msg-required="${plzEmiratedIDfrontAttchmsg}" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse"/>&hellip; 
																			<form:input path="emiratesIdFront" type="file" />
																		</span>
																	</span>
																</div>
			                                                </div>
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control readonly required" readonly="readonly" name="emiratesid-back" data-msg-required="${plzEmiratesIdBackAttchmsg}" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse"/>&hellip; 
												...
												<div class="col-md-12 remove-pad">
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control readonly required" readonly="readonly" name ="passportfrontpage" data-msg-required="${plzAttchPassportFrontmsg}" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse"/>&hellip; 
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control required readonly" readonly="readonly" name ="passport_residency_page" data-msg-required="${plzAttchPassportResidentmsg}" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse"/>&hellip; 
