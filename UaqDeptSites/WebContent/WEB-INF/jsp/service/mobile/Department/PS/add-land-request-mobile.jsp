...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
		...
		<c:set var ="erropagemsg"><spring:message code="label.service.erropage"/></c:set>
								...
								<div class="page-content-wrap">
													...
													<div class="form-group cf">
														...
														<div class="col-md-7">
															<div class="input-group file-upload">
																<input  type="text"
																	class="form-control " name="emiratesid-back" data-msg-required="${sitePlanDocReq}" readonly="readonly"/>
																<span class="input-group-btn"> <span
																	class="btn btn-file"> <spring:message code="file.browse" />&hellip; 
																	<input	name="sitePlanDocument" id="sitePlanDocument" type="file" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" readonly="readonly" />
																</span>
										...
										<div class="row">
											<div class="col-md-12 remove-pad">
	                                        	...
	                                        	<div><span class="error"> ${erropagemsg}</span></div>
	                                        	</c:if>
												</div>
											</div>
										</div>
