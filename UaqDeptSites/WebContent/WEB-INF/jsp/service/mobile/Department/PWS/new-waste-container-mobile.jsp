	                                            	...
	                                            	<div class="form-group cf">
			                                            ...
			                                            <div class="col-md-9">
		                                                    <div class="input-group file-upload">
		                                                        <input type="text" name="files1" class="form-control " id="attachment1" readonly data-msg-required="${deptlblattachmntmsg}" readonly="readonly" />
	                                                        	<span class="input-group-btn">
		                                                			<span class="btn btn-file">
		                                                				<spring:message code="file.browse"/>&hellip; 
		                                                				<input type="file" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" name="files[0]" id="wase_container_file_0" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" />
																	</span>
																</span>
