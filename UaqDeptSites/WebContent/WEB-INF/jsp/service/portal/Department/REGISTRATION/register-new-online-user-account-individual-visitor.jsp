...
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
		...
		<div class="container-fluid">
			...
			<div class="mainmenu">
					<div class="col-md-12 hidden-xs hidden-sm">
						<div class="mainmenu-wrap">
							<ul class="no-list cf">
								...
								<li class="active"><a href="#"><spring:message code="indivlVisitor"/></a>
								</li>
				...
				<c:set var="uploadVisa"><spring:message code = 'plzUploadVisa'/></c:set>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-9 col-md-10 title-txt">
										...
										<h2 class="page-title">
											...
											<spring:message code="label.gccvisitor" />
										</h2>
										<!-- /page title -->
									</div>
							...
							<div class="main-content-wrap">
								...
								<div class="page-content-wrap">
										<div class="form-content cf">
										   <form:form commandName="registrationIndividualVisitorCommand" name="feedbak" id="feedbak" class="eservice-form" enctype="multipart/form-data" method="post" action="visitorregister.html" >
										    <div class="row">
												<div class="row"> 
														...
														<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
															    <div class="col-md-4 col-xs-3 remove-pad  arbic-code">
																	<div class="custom-select-box cf">
																		<form:select path="mobileCode1"  class="required1" name="mobile_number1" required="required"   >
																...
																<div class="col-md-8 col-xs-9 remove-pad">
																	...
																	data-rule-maxlength="7" data-rule-minlength="7" data-msg-required="${valMobile}"
																	data-msg-maxlength="${valMobileLength}" 
																	data-msg-minlength="${valMobileLength}" data-rule-number="true" data-msg-number="${valMobile}" data-mask="0000000"/>
																</div>
			                                                </div>
		                                            	</div>
		                                        	...
		                                        	<div class="col-md-5 remove-pad col-md-offset-1">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="col-md-4 col-xs-3 remove-pad  arbic-code">
																	<div class="custom-select-box cf">
																		<form:select path="mobileCode2"  class="required1 required" name="mobile_number2" >
																			<form:option value="050">050</form:option>
																			<form:option value="052">052</form:option>
																			<form:option value="055">055</form:option>
																			<form:option value="056">056</form:option>
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																...
																<div class="col-md-8 col-xs-9 remove-pad">
																	...
																	data-rule-number="true" data-rule-minlength="7" data-msg-number="${enterValidlandlinemsg}"
																	data-msg-maxlength="${valMobileLength}" 
																	data-msg-minlength="${valMobileLength}" data-mask="0000000"/>
																</div>	
			                                                </div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-5 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="userName" id="username" name="username" type="text" class="form-control  required" required="required" data-msg-required="${userName}"
												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-5 remove-pad col-md-offset-1">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="confirmPassword"  type="password" id="confirm-password" equalto="#password_register" name="confirm-password" class="form-control" placeholder="" required="required" data-msg-equalto="${passwordMisMatchmsg}" data-msg-required="${passwordMisMatchmsg}" />
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-5 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="fullName" id="fullname" name="fullname" type="text" class="form-control charecterKey" required="required" data-msg-required="${fullNamereq}"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
											...
											<div class="row">
												<div class="col-md-12 remove-pad">	
													<div class="col-md-5 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="passportFrontPageLabel" class="form-lbl  mandatory_lbl"><spring:message code="passportFrontAttach" />
			                                                    </label>
				                                            </div>
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<form:input type="text" class="form-control required" path="passportFrontPageLabel" name ="passportFrontPageLabel" readonly="true" required="required"  data-msg-required="${uploadPassport}" />
													...
													<div class="col-md-5 remove-pad col-md-offset-1">
		                                            	...
		                                            	<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="visapage" class="form-lbl mandatory_lbl"><spring:message code="label.visaPage" />
			                                                    </label>
				                                            </div>
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<form:input type="text" class="form-control"  path="visapage" name ="visapage" readonly="true" required="required" data-msg-required="${uploadVisa}"/>
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<input type="file" class="upload" name="visaPage" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" id="visaPage" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" />
																		</span>
																		<form:hidden path="visaPage_name" id="visaPage_name" value=""/>
																	</span>
																</div>
			                                                </div>
		                                            	</div>
