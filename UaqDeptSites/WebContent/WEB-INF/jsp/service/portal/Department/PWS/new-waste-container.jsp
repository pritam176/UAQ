					...
					<div class="col-md-12 hidden-xs hidden-sm">
						<div class="mainmenu-wrap">
							<ul class="no-list cf">
								...
								<li class=""><a href="/${param.languageCode}/registrationlanding.html"><spring:message code="dept.lbl.department" /></a>
								</li>
						...
						<div class="main-content-wrap">
								<div class="page-content-wrap">
										<div class="form-content cf">
											<form:form commandName="wasteContainerCommand"     id="new_waist_container_form" enctype="multipart/form-data" action="wastecontainer.html" method="POST"> 
												<!-- map search element -->
												<div class="row">
	                                            	...
	                                            	<div class="form-group cf">
			                                            ...
			                                            <div class="col-md-9">
		                                                    <div class="input-group file-upload">
		                                                        <input type="text" name="files1" id="attachment1" class="form-control " readonly data-msg-required="${deptlblattachmntmsg}" />
	                                                        	<span class="input-group-btn">
		                                                			<span class="btn btn-file">
		                                                				<spring:message code="file.browse"/>&hellip; 
		                                                				<input type="file" name="files[0]" id="wase_container_file_0" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" />
																	</span>
																</span>
	                                        	...
	                                        	<div class="row">
		                                            <div class="form-group">
		                                                <div class="col-md-offset-3 col-md-9">
		                                                    <input type="submit" class="btn form-control-btnsbmt" value='<spring:message code="form.button.submit"/>' />
    ...
    function updatePosition() {
		...
		$("input[name='serviceType']").click(function(){
			 if($(this).val()=="replacement"){
				...
				$("#attachment1").addClass("required");
				$("#reason_replacement").attr("readonly", false);
				$("#attachment1").next("label").hide();
				...
				$("#attachment1").removeClass("required");
				$("#attachment1").next("label").hide();
				$("#reason_replacement").next("label").hide();
