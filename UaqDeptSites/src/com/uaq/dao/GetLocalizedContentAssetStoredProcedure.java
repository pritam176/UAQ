 ...
 * 
 */
public class GetLocalizedContentAssetStoredProcedure extends StoredProcedure {

	private static final String storeProcedureName = "GETLOCALIZED_CONTENT_ASSET";

	public GetLocalizedContentAssetStoredProcedure(JdbcTemplate jdbcTemplate) {
