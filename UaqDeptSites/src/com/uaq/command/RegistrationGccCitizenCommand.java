 ...
 *
 */
public class RegistrationGccCitizenCommand {

	private String fullNameEmirates;
	...
	private String emiratesIdExpDate;
	private String emirates;
	private String dob;

	private String emiratesIdFrontside_name;
	private String emiratesIdBackSide_name;
	private String passportNumber;
	private String passportFrontPage_name;
	...
	public String getMobileCode2() {
		return mobileCode2;
	}

	public void setMobileCode2(String mobileCode2) {
		this.mobileCode2 = mobileCode2;
	}
	...
	public String getFullNameEmirates() {
		return fullNameEmirates;
	}

	public void setFullNameEmirates(String fullNameEmirates) {
		this.fullNameEmirates = fullNameEmirates;
	}

	public String getEmiratesIdFrontside_name() {
		return emiratesIdFrontside_name;
	}

	public void setEmiratesIdFrontside_name(String emiratesIdFrontside_name) {
		this.emiratesIdFrontside_name = emiratesIdFrontside_name;
	}
	...
	public String getPassportFrontPage_name() {
		return passportFrontPage_name;
	}

	public void setPassportFrontPage_name(String passportFrontPage_name) {
		this.passportFrontPage_name = passportFrontPage_name;
	}
