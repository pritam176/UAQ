...
public class PaymentHistoryService {
	...
	private uaq.mobile.wrapper.PaymentHistoryService  paymentHistoryService =null;
	PaymentHistoryPortBindingStub stub;
	PaymentHistory port =null;
	
	private uaq.mobile.wrapper.UserContext uc = null;
	...
	public List<PaymentHistoryVO>getPaymentHistoryList (String accountId){
		...
		try {
			ProcessResponseListType [] processResponseListType	= stub.getPaymentHistory(accountId, uc);
