...
import uaq.middleware.services.ps.PSAddLandSubmitNOC;
import uaq.middleware.services.ps.PSAddLandSubmitNOCPortBindingStub;
import uaq.middleware.services.ps.PSAddLandSubmitNOCService;
import uaq.middleware.services.ps.PSAddLandSubmitNOCServiceLocator;
import uaq.middleware.services.ps.UserContext;

import com.AddLandRequest.Inputpayload;
import com.AddLandRequest.NewSubmitNOCRecPayload;
...
public class SubmitNOCRequestService {
	...
	private PSAddLandSubmitNOCService service=null;
	private PSAddLandSubmitNOC port=null;
	private PSAddLandSubmitNOCPortBindingStub stub=null;
	
	protected static UAQLogger logger =new UAQLogger(SubmitNOCRequestService.class);
	
	private uaq.middleware.services.ps.UserContext uc=null;
	...
	public void createStub(){
		...
		try {
			service=(PSAddLandSubmitNOCService) new PSAddLandSubmitNOCServiceLocator();
			port=service.getPSAddLandSubmitNOCPort();
			stub=(PSAddLandSubmitNOCPortBindingStub) port;
