...
//		mobileDetailsParams.add(new Param("mobileMessage",getSMS(inputParams.get("requestNumber").toString(),inputParams.get("amount").toString())));
//		
//		
//		List<Param> emailDetailsParams = new ArrayList<Param>();
//		emailDetailsParams.add(new Param("emailSubject",getEmailSubject(inputParams.get("requestNumber").toString(),inputParams.get("amount").toString())));
//		emailDetailsParams.add(new Param("emailBody",getEmailBody(inputParams.get("applicantName").toString(), inputParams.get("requestNumber").toString(), inputParams.get("transactionId").toString(), inputParams.get("amount").toString())));
...
//		pushDetailsParams.add(new Param("pnMessage",getPN(inputParams.get("requestNumber").toString(),inputParams.get("amount").toString())));
//		
//		
//		
//		List<Param> detailsParams = new ArrayList<Param>();
...
//		notificationParams.add(new Param("notification", null,detailsParams));
//
//		boolean hasResponse = false;
...
//	
//	
//	private static String getSMS(String requestNo, String amount){
//		return "Service fees paid successfully for request number: "+requestNo+" Ediram Fees:- "+amount+" AED.";
//	}
//	private static String getPN(String requestNo, String amount){
//		return "Service fees paid successfully for request number: "+requestNo+" Ediram Fees:- "+amount+" AED.";
//	}
//	private static String getEmailSubject(String requestNo, String amount){
//		return "Service Fees Paid succesfully for Request No: "+requestNo;
//	}
//	
//	private static String getEmailBody(String name, String requestNo, String transactionId, String amount){
//		return "<html>\r\n" + 
//				"<body>\r\n" + 
//				"<div>\r\n" + 
//				"<h1>Dear "+name+",</h1>\r\n" + 
//				"<p>Service fees paid successfully for request number: "+requestNo+". \r\n" + 
//				"<br>Below are the details of transaction.\r\n" + 
//				"<br>Ediram Transaction Id:- "+transactionId+"\r\n" + 
//				"<br>Ediram Fees:- "+amount+" AED.</p>\r\n" + 
//				"<p>Thanks &amp; Regards,</p>\r\n" + 
//				"<p>UAQ Admin.</p>\r\n" + 
//				"</div>\r\n" + 
//				"</body>\r\n" + 
