	...
	<nav class="navbar col-sm-8 col-xs-12">
		<ul class="nolist pull-right cf navbarItems">
			...
			<li class="navItem lang"><c:if test="${param.languageCode=='en'}">
					<a href="/${param.languageCode}/changeLanguage.html?fromPage=${source}"> <spring:message code="change.arabic" />
					</a>
				</c:if> <c:if test="${param.languageCode=='ar'}">
					<a href="/${param.languageCode}/changeLanguage.html?fromPage=${source}"> <spring:message code="change.english" />
					</a>
				</c:if></li>
		...
		<div class="mob-search visible-xs">
			...
			<form:form commandName="searchCommand" name="headersearch" action="/${param.languageCode}/search.html" method="post">
		...
		<div class="modal-content">
			<div class="header-modal-wrap">
				...
				<div class="modal-body">
					<form:form name="login-form" id="login-form" action="#" commandName="logincommand" method="post">
						<div class="row">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-6 col-md-5">
										<div class="form-group">
											...
											<form:input type="text" class="modal-txt required" id="username" path="username" placeholder="${phUsername}" />
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-5">
										<div class="form-group">
											<c:set var="phPassword"><spring:message code='header.password'/></c:set>
											<form:password path="password" class="modal-txt required" id="password" name="password" placeholder="${phPassword}" />
											<form:hidden path="loginStatus" id="loginStatus"/>
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-2">
										<input type="button" class="popup-btn " id="user_login" value="<spring:message code="header.login" />" />
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
									...
									<div class="profile-settings">
										...
										<div class="profile-group ">
											<a href="/${param.languageCode}/userprofile.html" id="welcome_profile_url" class="modal-head-link ">
												<span class="welcom-icons"><img src="/img/profile.png" alt="My Profile"/></span><label class="hidden-xs">${UserName}</label> 
											</a>
										</div>
										<div class="profile-group ">
