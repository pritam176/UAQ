		...
		<div class="container-fluid">
			<div class="wrapper">
				...
				<div class="content">
					...
					<c:set var="siteplanReq"><spring:message code="label.ps.issuesitePlan.required" /></c:set>
					...
					<c:set var="sitePlanDocReq"><spring:message code="label.ps.issuesitePlanDoc.required" /></c:set>
					<c:set var="landUsageReq"><spring:message code="label.ps.landUsage.required" /></c:set>
						...
						<div class="col-xs-12 col-sm-9 col-md-9 main-left-col">
							...
							<div class="main-content-wrap">
								...
								<div class="page-content-wrap">
										...
										<form:form  id="feedbak" commandName="issueSitePlanDocumentCommand" enctype="multipart/form-data" method="post" action="issuesiteplandoc.html" >
										    <div class="row"></div>	
													...
													<div class="col-md-9">
														...
														<div class="col-md-3 remove-pad">
															<div class="radio inline-custom">
																<form:radiobutton id="sector-radio" path="locations" name="locations" value="sector" class="radiobtn required" checked="checked" />
												...
												<div class="col-md-12 remove-pad">
				                                            ...
				                                            <div class="col-md-7">
																<div class="col-md-12 col-xs-12 remove-pad">
																	<div class="custom-select-box cf">
																		<form:select path="sector"  class="required1 required" id="sector-select" name="sector1"  disabled="disabled" data-msg-required="${sectorReq}">
																			<option value=""><spring:message code="label.ps.selectsector" /></option>
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="block"  type="text" id="block" name="block" class="form-control sectorform required"  readonly="readonly" data-msg-required="${blockReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="subsector" id="subsector" name="subsector" type="text" class="form-control sectorform required"  readonly="readonly" data-msg-required="${subSectorReq}"  maxlength="20" />
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="sectorPlotNumber" id="plotnumber" name="plotnumber" type="text" class="form-control sectorform required "  readonly="readonly" data-msg-required="${plotNoReq}"  data-msg-number="${plotNoReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
											...
											<div class="row">
												<div class="form-group cf">
													<div class="col-md-9">
														...
														<div class="col-md-3 remove-pad">
															<div class="radio inline-custom">
																<form:radiobutton path="locations" id="replacement1"  name="locations" value="area" class="radiobtn"/>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="col-md-12 col-xs-12 remove-pad">
																	<div class="custom-select-box cf">
																		<form:select path="area"  class="required1 required" id="area-select" name="area1" disabled="disabled" data-msg-required="${areaReq}" >
																				<option value=""><spring:message code="label.ps.selectarea" /></option>
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="areaBlock"  type="text" id="area-block" name="area-block" class="form-control areaform required" readonly="readonly" data-msg-required="${blockReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="subArea" id="sub-area" name="sub-area" type="text" class="form-control areaform required " readonly="readonly" data-msg-required="${subAreaReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="areaPlotNumber" id="area-plotnumber" name="area-plotnumber" type="text" class="form-control areaform required" readonly="readonly" data-msg-required="${plotNoReq}" data-msg-number="${plotNoReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
															...
															<div class="col-md-7">
																	...
																	<div class="custom-select-box cf">
																		<form:select path="landUsage" class="required1 required"
																			...
																			<option value=""><spring:message code="label.ps.selectlandusage" /></option>
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control required" name="emiratesid-back" data-msg-required="${sitePlanDocReq}" readonly="readonly" />
