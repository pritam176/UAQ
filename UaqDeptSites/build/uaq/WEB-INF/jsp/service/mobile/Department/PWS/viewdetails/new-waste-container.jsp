										...
										<div class="form-content cf">
											<form:form commandName="wasteContainerCommand"     id="new_waist_container_form" enctype="multipart/form-data" action="resubmitwastecontainer.html" method="POST"> 
												...
												<div class="row">
	                                            	<div class="form-group cf">
		                                                <div class="col-md-3">
		                                                    <label class="form-lbl"><spring:message code="dept.lbl.pws.location" />
		                                                    </label>
			                                            </div>
			                                            <div class="col-md-9">
												...
												<div class="row">
	                                            	<div class="form-group cf">
		                                                <div class="col-md-3">
		                                                    <label class="form-lbl"><spring:message code="label.address" />
		                                                    </label>
			                                            </div>
			                                            <div class="col-md-9">
		                                                    <form:input type="text" path="address" id="address" class="form-control required"  name="address" data-msg-required="${plzdeptlbladdresmsg}" />
		                                                </div>
	                                            	</div>
	                                        	</div>
	                                        	<!-- /address element -->
												...
												<div class="row">
	                                            	<div class="form-group cf">
			                                            ...
			                                            <div class="col-md-9">
			                                            	<!-- radio button -->
															<c:choose>
															<c:when test="${empty fn:trim(replacment) }">
															...
															<div class="col-md-3 remove-pad cf">
		                                                        <div class="radio inline-custom">
		                                                            <form:radiobutton id="replacement" checked="checked" path="serviceType" value="replacement"></form:radiobutton>
		                                                    ...
		                                                    <div class="col-md-6 remove-pad">
		                                                    	<div class="col-md-4 remove-pad">
				                                                    <label class="form-lbl"><spring:message code="dept.lbl.pws.rplmntrsn" /></label>
					                                            </div>
...
<!-- ----- uploaded file area starts here --->
											...
											<div class="row">
	                                            	<div class="form-group cf">
		                                                <div class="col-md-3">
		                                                    <label class="form-lbl"><spring:message code="label.service.optionalcomments" />
		                                                    </label>
			                                            </div>
			                                            <div class="col-md-9">
...
function updatePosition() {
	...
	google.maps.event.addDomListener(window, 'load', initialize);
		...
		$("#search_location").attr("readonly", true);
		$("#wase_container_file_0").attr("readonly", true);
