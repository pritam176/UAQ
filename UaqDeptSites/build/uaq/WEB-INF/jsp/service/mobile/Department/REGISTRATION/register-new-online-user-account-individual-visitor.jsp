					...
					<div class="col-md-12 hidden-xs hidden-sm">
						<div class="mainmenu-wrap">
							<ul class="no-list cf">
								...
								<li class="/${param.languageCode}/registrationlanding.html"><a href="#"><spring:message code="registration" /></a>
								</li>
							...
							<div class="main-content-wrap">
								...
								<div class="page-content-wrap">
										<div class="form-content cf">
										   <form:form commandName="registrationIndividualVisitorCommand" name="feedbak" id="feedbak" enctype="multipart/form-data" method="post" action="visitorregister.html" >
										    <div class="row">
												<div class="row"> 
												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="email"  type="email" id="email" name="email" class="form-control"  required="required"  data-msg-required="${emailMsg}"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <form:input path="password" id="password_register" name="password_register" type="password" class="form-control" placeholder="Password" required="required"
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="fullName" id="fullname" name="fullname" type="text" class="form-control" required="required" data-msg-required="${fullNamereq}"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
											...
											<div class="row">
												<div class="col-md-12 remove-pad">	
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="emiratesid-front" class="form-lbl  mandatory_lbl"><spring:message code="passportFrontAttach" />
			                                                    </label>
				                                            </div>
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control required" name ="emiratesid-front" readonly required="required"  data-msg-required="${uploadPassport}"/>
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="visa_page" class="form-lbl mandatory_lbl"><spring:message code="label.visaPage" />
			                                                    </label>
				                                            </div>
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	<input type="text" class="form-control" name ="visa_page" readonly required="required" data-msg-required="${uploadVisa}"/>
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<form:input path="visaPage" type="file" />
																		</span>
																	</span>
																</div>
			                                                </div>
