...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="container-fluid">
		...
		<div class="mainmenu">
					<div class="col-md-12 hidden-xs hidden-sm">
						<div class="mainmenu-wrap">
							<ul class="no-list cf">
								...
								<li class="active"><a href="#"><spring:message code="label.lp.renewProCard" /></a>
								</li>
			...
			<c:set var="proReq"><spring:message code="label.lp.pro.required" /></c:set>
						...
						<div class="page-title-wrap">
							<div class="row">
								<div class="col-xs-12 col-sm-9 col-md-10 title-txt">
									...
									<!-- page title -->
									<h2 class="page-title">
										<spring:message code="label.lp.renewProCard" />
										<!--- BPM03.1.01: pgno 19 -->
									</h2>
									<!-- /page title -->
								</div>
											...
											<div class="col-md-12 remove-pad">
												<div class="col-md-6 remove-pad">
													...
													<div class="form-group cf">
														<div class="col-md-5">
															<label for="pro-name" class="form-lbl mandatory_lbl"><spring:message code="label.lp.selectPro" /> </label>
														</div>
														<div class="col-md-7">
															<div class="custom-select-box cf">
																<form:select path="proName" class="required1 required"
																	name="land-status" data-msg-required="${proReq}">
												...
												<div class="col-md-6 remove-pad">
													...
													<div class="form-group cf">
														<div class="col-md-5 col-xs-6">
															<label for="pro-id" class="form-lbl "><spring:message code="label.lp.proName" /> </label>
														</div>
										...
										<div class="row">
											<div class="col-md-12 remove-pad">
												<div class="col-md-6 remove-pad">
													...
													<div class="form-group cf">
														<div class="col-md-5 col-xs-6">
															<label class="form-lbl-txt"><spring:message code="label.lp.proIdNo" />  </label>
														</div>
														<div class="col-md-7 col-xs-6">
										...
										<div class="row">
											<div class="col-md-12 remove-pad">
												<div class="col-md-6 remove-pad">
													...
													<div class="form-group cf">
														<div class="col-md-5">
															<label for="pro-exp-date" class="form-lbl "><spring:message code="label.lp.proExpDate" /> </label>
														</div>
														<div class="col-md-7">
										...
										<div class="row">
											<div class="col-md-12 remove-pad">
												<div class="col-md-6 remove-pad">
													...
													<div class="form-group cf">
														<div class="col-md-5">
															<label for="land-status" class="form-lbl "><spring:message code="label.lp.proNationality" /> </label>
														</div>
														<div class="col-md-7">
