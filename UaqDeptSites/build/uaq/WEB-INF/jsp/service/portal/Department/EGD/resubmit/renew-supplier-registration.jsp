										...
										<div class="form-group cf">
											...
											<div class="col-md-7">
												<form:input id="email" path="email" type="email"
													class="form-control required"
													data-msg-required="${emailReq}" readonly="true" data-msg-email="Please enter valid email"/>
											</div>
											<!-- /text box -->
										</div>
									</div>
										...
										<div class="form-group cf">
											...
											<div class="col-md-7">
												<form:input type="text" id="office_telephone"
													...
													data-msg-maxlength="${valofficeLength}" data-msg-minlength="${valofficeLength}" maxlength="10" data-mask="00-0000000"  />
											</div>
										</div>
									</div>
								</div>
										...
										<div class="form-group cf">
											...
											<div class="col-md-7">
												<form:input type="text" id="post_box" path="postBox"
													class="form-control required"
													data-msg-required="${postBoxReq}" data-rule-maxlength="10" 
												...
												<div class="input-group file-upload">
													<input type="text" class="form-control"
														...
														class="input-group-btn"> <span class="btn btn-file">
															<spring:message code="file.browse" />&hellip; 
															<input 	name="certificates" type="file" id="supplier_file_0" data-msg-required="${commerceReq}" id="chamberOfCommerce" error-size="${filesize}" accept="image/jpg, image/JPG, image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" error-extention="${fileextention}" error-failed="${fileerror}"  />
															</span>
															</span>
												...
												<div class="col-md-offset-5 col-md-7">
												 <c:if test="${status ne '6' }">
													<input type="submit" class="btn"
														value='<spring:message code="label.eservice.resubmit"/>' />
														</c:if>
												</div>
											</div>
										</div>
