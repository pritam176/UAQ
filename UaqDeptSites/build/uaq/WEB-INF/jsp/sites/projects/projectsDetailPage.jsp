...
<div class="page-content-wrapper">
	<div class="row">
		<div class="col-lg-9 col-sm-9 col-md-9 col-xs-12">
			...
			<c:set var="subjectValue" value="${projectsVO.title}"/>
			<div class="page-title-mob">
				...
				<h2 class="main-title no-border">${projectsVO.title}</h2>
				<div class="detail-post-content">
					<span class="post-date">${projectsVO.dateAndTime}</span>
					<c:if test="${not empty projectsVO.images}">
						<c:forEach items="${projectsVO.images}" var="imageVO">
							<img src="${imageVO.genericContentImage}"
...
<script type="text/javascript">
	...
	var sub_value = '${projectsVO.title}';
