											...
											<div class="row">
												<div class="col-md-12 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                   	<form:input path="tradeLicenceNumber" readonly="true"  type="text" id="trade_licence" name="trade_licence" class="form-control required"  required="required" data-msg-required="${tradeLicReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
															...
															<div class="col-md-7">
																<form:input path="email" readonly="true" id="email"  name="email" type="email" class="form-control required" data-msg-required="${emailReq}" data-msg-email="Please enter valid email"/>
															</div>
														<!-- /text box -->
														</div>
		                                        	</div>
													...
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
															...
															<div class="col-md-7">
																...
																data-msg-required="${officeTelReq}" data-rule-maxlength="10" data-rule-minlength="10" 
																  data-msg-number="${valMobile}" placeholder="0[x]-xxxxxxx"
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <div class="input-group file-upload">
																	<input type="text" class="form-control" name ="trading_attach1" readonly="readonly" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<input name="chamberOfCommerce" type="file"  accept="image/jpg, image/JPG, image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" data-msg-required="${commerceReq}" id="chamberOfCommerce" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" />
																	</span>
																</span>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <div class="input-group file-upload">
																	<input type="text" class="form-control" name ="trading_attach" data-msg-required="${certificatesReq}" readonly="readonly" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<input name="certificates" type="file"   accept="image/jpg, image/JPG, image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" id="supplier_file_0" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" />
																	</span>
																</span>
											...
											<div class="row">
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
															<div class="col-md-5">
																<label  for="supp_category" class="form-lbl form-lbl-text"><spring:message code="label.service.optionalcomments" />
																</label>
															</div>
															<div class="col-md-7">
