							...
							<div class="page-title-wrap">
								<div class="row">
									<div class="col-xs-12 col-sm-9 col-md-10 title-txt">
										...
										<!-- page title -->
										<h2 class="page-title">
										<spring:message code="label.ps.landDemorcation" />	       <!--- ps page 21 -->
										</h2>
										<!-- /page title -->
									</div>
							...
							<div class="main-content-wrap">
								...
								<div class="page-content-wrap">
										<div class="form-content cf">
										   <form:form commandName="landDemarcationRequestCommand"   id="feedbak" enctype="multipart/form-data" method="post" action="landdemarcationrequest.html" >
										    <div class="row"></div>	
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																	<form:input id="plan-number" path="sitePlanNumber" type="text"  class="form-control " data-msg-required="${siteplanReq}"  data-mask="0000000000"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
													...
													<div class="col-md-9">
														...
														<div class="col-md-3 remove-pad">
															<div class="radio inline-custom">
																<form:radiobutton id="sector-radio" path="locations" value="sector" class="radiobtn required"  checked="checked"/>
												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input  type="text" id="block" path="block" class="form-control sectorform required"  readonly="readonly" data-msg-required="${blockReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input id="sectorPlotNumber" path="sectorPlotNumber" type="text" class="form-control sectorform required "  readonly="readonly" data-msg-required="${plotNoReq}" data-msg-number="${plotNoReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input id="area-plotnumber" path="areaPlotNumber" type="text" class="form-control areaform required" readonly="readonly" data-msg-required="${plotNoReq}"  data-msg-number="${plotNoReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
															...
															<div class="col-md-7">
																	...
																	<div class="custom-select-box cf">
																		<form:select path="landUsage" class="required1 required"
																			id="land-usage" name="sub-area"  data-msg-required="${landUsageReq}">
																			<form:option value=""><spring:message code="option.select"/> </form:option> 
																...
																<div class="input-group file-upload">
																	...
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			...
																			<input type="file" name="sitePlanDocument" id="sitePlanDocument" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword"  error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}">
																		</span>
