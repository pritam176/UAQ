								...
								<div class="form-content cf">
									<form:form commandName="addLandRequestCommand" name="feedbak"
													...
													<div class="form-group cf">
														...
														<div class="col-md-7">
															<form:input path="siteNumber" id="plan-number"
																...
																class="form-control required" readonly="readonly" data-msg-required="${siteplanReq}" data-mask="0000000000"/>
														</div>
													</div>
													<!-- /text box -->
												</div>
										...
										<div class="row">
											<div class="col-md-12">
												<!-- form-sect-head-->
												<h5 class="form-title"><spring:message code="label.ps.location.reject" /> </h5>
											</div>
											<!-- /form-sect-head-->
										</div>
														...
														<div class="col-md-7">
															<div class="input-group file-upload">
																<form:input path="" type="text"
																	class="form-control required" name="emiratesid-back" readonly="readonly" data-msg-required="${sitePlanDocReq}"/>
