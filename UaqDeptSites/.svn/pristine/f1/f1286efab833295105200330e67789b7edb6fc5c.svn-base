...
public class ThankYouPageController extends BaseController {
	...
	public String handleThankYouPage(HttpServletRequest request, ModelMap model) {
		logger.enter("handleThankYouPage");
		...
		String[] messageParams = request.getParameterValues("messageParams");
		...
		if (!StringUtil.isEmpty(messageId)) {
			model.addAttribute("actmessage", messageSource.getMessage(messageId, messageParams, locale));
		}
