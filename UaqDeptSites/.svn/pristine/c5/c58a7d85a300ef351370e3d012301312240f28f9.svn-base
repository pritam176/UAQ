						...
						<div class="col-xs-12 col-sm-9 col-md-9 main-left-col">
							...
							<div class="main-content-wrap">
								...
								<div class="page-content-wrap">
								 ...
								 id="feedbak"
								enctype="multipart/form-data" method="post" action="resubmitreNewSupplierRegistrationPage.html">
										    <div class="row">
												<div class="row"> 
													...
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
															...
															<div class="col-md-7">
																...
																data-msg-required="${officeTelReq}" data-rule-maxlength="10" placeholder="0[x]-xxxxxxx" data-rule-minlength="10" 
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                     <div class="input-group file-upload attachment-btm">
											...
											<div class="row">
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="trading_attach2" class="form-lbl mandatory_lbl"><spring:message code="label.egd.signatoryAttest" /></label>
				                                            </div>
				                                            <div class="col-md-7">
			                                                   <div class="input-group file-upload attachment-btm">
																<c:forEach items="${userAttachmentsList}" var="userAttachmentVO">
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
			                                                    <div class="input-group file-upload">
																	<input type="text" class="form-control" name ="trading_attach" readonly="readonly" />
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<input name="certificates" type="file" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" data-msg-required="${certificatesReq}"  id="supplier_file_0" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" data-msg-required="${certificatesReq}" />
																	</span>
																</span>
											...
											<div class="row">
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
															<div class="col-md-5">
																<label  for="supp_category" class="form-lbl form-lbl-text">Comment
																</label>
															</div>
															<div class="col-md-7">
