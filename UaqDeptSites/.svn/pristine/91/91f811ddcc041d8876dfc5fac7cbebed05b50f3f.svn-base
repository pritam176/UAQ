...
<body>
	<form:form>
		...
		<table width="62%" cellspacing="5">
			<tr>
				<td width="21%"><label>FullName &nbsp; (as stated in
						the passport)</label></td>
			...
			<tr>
				<td width="21%"><label>Passport First Page</label></td>
				<td width="28%"><form:input path="" type="file" name="passNum"
						style="width: 150px;" /></td>
				<td width="30%"><label>Passport Residency Page</label></td>
				<td><form:input path="" type="file" name="passResPage"
						style="width: 150px;" /></td>
