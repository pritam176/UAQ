...
<title>Submit Trading Licence</title>
<style>
.details
{
...
<table width="541">
  <tr>
    <td width="28%" height="30"><b>Request No</b> </td>
    <td colspan="2">LP-007-15-000023</td>
    </tr>
  <tr>
    <td height="31"><b>Applicant Details</b></td>
    <td width="26%">GH Real Estate</td>
    <td width="46%"><form:input type="button" path="details" value="moreinfo" /></td>
  </tr>
</table><br /><br />
