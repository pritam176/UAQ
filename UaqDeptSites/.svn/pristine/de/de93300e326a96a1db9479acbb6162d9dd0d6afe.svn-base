					...
					<div class="col-md-12 hidden-xs hidden-sm">
						<div class="mainmenu-wrap">
							<ul class="no-list cf">
								...
								<li class="active"><a href="#"><spring:message code="label.ps.landDemorcation" /></a>
								</li>
							...
							<div class="page-title-wrap">
								<div class="row">
									<div class="col-xs-12 col-sm-9 col-md-10 title-txt">
										...
										<!-- page title -->
										<h2 class="page-title">
										<spring:message code="label.ps.landDemorcation" />	
								...
								<div class="page-content-wrap">
										<div class="form-content cf">
										   <form:form commandName="landDemarcationRequestCommand"   id="feedbak" enctype="multipart/form-data" method="post" action="resubmitlanddemarcationrequest.html" >
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input id="plan-number" disabled="true" path="sitePlanNumber" type="text"  class="form-control required" data-msg-required="${siteplanReq}" data-mask="0000000000"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
											...
											<!--Sector Section starts Here -->
											<c:if test ="${landDemarcationRequestCommand.locations =='sector'}">
											<div class="row">
												<div class="form-group cf">
													...
													<div class="col-md-9">
														...
														<div class="col-md-3 remove-pad">
															<div class="radio inline-custom">
																<form:radiobutton id="sector-radio" disabled="true"  path="locations" value="sector" class="radiobtn required"  />
												...
												<div class="col-md-12 remove-pad">
				                                            ...
				                                            <div class="col-md-7">
																<div class="col-md-12 col-xs-12 remove-pad">
																	<div class="custom-select-box">
																		<form:select  class="required1 required" id="sector-select" path="sector"  disabled="true" data-msg-required="${sectorReq}">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input disabled="true"  type="text" id="block" path="block" class="form-control sectorform required"  readonly="readonly" data-msg-required="${blockReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input disabled="true" id="subsector" path="subsector" type="text" class="form-control sectorform required"  readonly="readonly" data-msg-required="${subSectorReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input id="sectorPlotNumber" disabled="true" path="sectorPlotNumber" type="text" class="form-control sectorform required "  readonly="readonly" data-msg-required="${plotNoReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
											...
											<!-- Sector Section Ends Here -->
											<!--  Area starts here !!!!!!!!!  -->
											<c:if test ="${landDemarcationRequestCommand.locations =='area'}">
											<div class="row">
												<div class="form-group cf">
													<div class="col-md-9">
														<!-- radio button -->
														<div class="col-md-3 remove-pad">
															<div class="radio inline-custom">
																<form:radiobutton id="replacement1" disabled="true"  path="locations" value="area" class="radiobtn"/>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<div class="col-md-12 col-xs-12 remove-pad">
																	<div class="custom-select-box">
																		<form:select  class="required1 required" id="area-select" path="area" disabled="true" data-msg-required="${areaReq}">
																			<form:option value=""><spring:message code="option.select"/> </form:option> 
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input disabled="true" type="text" id="area-block" path="areablock" class="form-control areaform required" readonl="readonly" data-msg-required="${blockReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input disabled="true" id="sub-area" path="subarea" type="text" class="form-control areaform required " readonly="readonly" data-msg-required="${subAreaReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input disabled="true" id="area-plotnumber" path="areaPlotNumber" type="text" class="form-control areaform required" readonly="readonly" data-msg-required="${plotNoReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
