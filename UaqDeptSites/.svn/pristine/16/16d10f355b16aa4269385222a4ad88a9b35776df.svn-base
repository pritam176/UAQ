...
<div class="content">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-9 col-md-9 main-left-col">
			<!-- page title -->
			<div class="page-title-wrap page-title-wrap-funeral">
				<div class="row">
					<div class="col-xs-12 col-sm-9 col-md-10 title-txt page-title-wrap-funerial">
						<!-- sub page title 
				...
				<div class="page-content-wrap">
					<div class="row">
						<div class="col-md-12 thankyou-page">
							<h2>
								<spring:message code="form.funeral.confirmation" />
								
							</h2>
							<a href="/${param.languageCode}/funeral.html"class="red-btn"> <spring:message code="page.back" /></a>
						</div>
					</div>
				</div>
			</div>
