												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="familyBookNo" id="familybooknum" name="familybooknum" type="text" class="form-control  other-form" data-msg-required="${familyBookNoReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="spouseIdNo" id="spouseid" name="spouseid" type="text" class="form-control  other-form"  data-msg-required="${spouseIdReq}" data-msg-minlength="${valLength}" data-rule-minlength="18" data-mask="000-0000-0000000-0"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
			                                                    ...
			                                                    <div class="input-group file-upload">
																	...
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			...
																			<input name="scanFamilyBook" id="scanFamilyBook" type="file" data-msg-required="${familyBookScanReq}" accept="image/jpg, image/JPG, image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}" />
																		</span>
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	...
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<input name="sposeEmiratesId" type="file" data-msg-required="${spouseEmiratesReq}" id="sposeEmiratesId" accept="image/jpg, image/JPG, image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" error-size="${filesize}" error-extention="${fileextention}" error-failed="${fileerror}"  />
																		</span>
