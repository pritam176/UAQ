	...
	<br>
		...
		<table width="400">
			...
			<tr>
				...
				<td><form:input path="proIdentity" type="file" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" /></td>
			</tr>
			<tr>
				<td><label>PRO Photograph</label></td>
				<td><form:input path="proPhoto" type="file" accept="image/jpg, image/JPG,image/JPEG, image/jpeg,image/jpeg,image/gif,image/png, application/pdf,image/x-eps, application/msword" /></td>
			</tr>
		</table>
		<br>
		<table>
