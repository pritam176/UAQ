												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																	<form:input path="sitePlanNumber" readonly="true" id="plan-number" name="plan-number" type="text"  class="form-control required"  data-mask="0000000000"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
													...
													<div class="col-md-9">
														...
														<div class="col-md-3 remove-pad">
															<div class="radio inline-custom">
																<form:radiobutton disabled="true" id="sector-radio" path="locations" name="locations" value="sector" class="radiobtn required" checked="checked" />
												...
												<div class="col-md-12 remove-pad">
																...
																<div class="col-md-12 col-xs-12 remove-pad">
																	<div class="custom-select-box">
																		<form:select path="sector"   class="required1 required" id="sector-select" name="sector1"  disabled="true" data-msg-required="${sectorReq}">
																			<option><spring:message code="label.ps.selectsector" /></option>
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="block"  type="text" id="block" name="block" class="form-control sectorform required"  readonly="true" data-msg-required="${blockReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="subsector" id="subsector" name="subsector" type="text" class="form-control sectorform required"  readonly="true" data-msg-required="${subSectorReq}" maxlength="20" />
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="sectorPlotNumber" id="plotnumber" name="plotnumber" type="text" class="form-control sectorform required "  readonly="true" data-msg-required="${plotNoReq}"  data-msg-number="${plotNoReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
																...
																<div class="col-md-12 col-xs-12 remove-pad">
																	<div class="custom-select-box">
																		<form:select path="area"   class="required1 required" id="area-select" name="area1" disabled="true" data-msg-required="${areaReq}" >
																				<option><spring:message code="label.ps.selectarea" /></option>
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="areaBlock"  type="text" id="area-block" name="area-block" class="form-control areaform required" readonly="true" data-msg-required="${blockReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													...
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="areaPlotNumber" id="area-plotnumber" name="area-plotnumber" type="text" class="form-control areaform required" readonly="true" data-msg-required="${plotNoReq}" data-msg-number="${plotNoReq}" maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
															...
															<div class="col-md-7">
																	...
																	<div class="custom-select-box cf">
																		<form:select path="landUsage" class="required1 required" disabled="true"
																			...
																			<option><spring:message code="label.ps.selectlandusage" /></option>
