												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input  type="text" disabled="true" id="block" path="block" class="form-control sectorform required"  readonly="readonly" data-msg-required="${blockReq}"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input id="subsector" disabled="true" path="subsector" type="text" class="form-control sectorform required"  readonly="readonly" data-msg-required="${subSectorReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input id="sectorPlotNumber" path="sectorPlotNumber" disabled="true" type="text" class="form-control sectorform required "  readonly="readonly" data-msg-required="${plotNoReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input  type="text" disabled="true" id="area-block" path="areablock" class="form-control areaform required" readonl="readonly" data-msg-required="${blockReq}"  maxlength="20"/>
			                                                </div>
		                                            	</div>
															...
															<div class="col-md-7">
																	...
																	<div class="custom-select-box cf">
																		<form:select path="landUsage" class="required1 required"
																			id="land-usage" name="landUsage" disabled="true" data-msg-required="${landUsageReq}">
																			<form:option value=""><spring:message code="option.select"/> </form:option> 
