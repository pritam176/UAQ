													...
													<div class="col-md-9">
														...
														<div class="col-md-3 remove-pad">
															<div class="radio inline-custom">
																<form:radiobutton id="sector-radio" path="locations" name="locations" value="sector" class="radiobtn required"  />
												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="block"  type="text" id="block" name="block" class="form-control sectorform required"  readonly="readonly" data-msg-required="${blockReq}"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="subsector" id="subsector" name="subsector" type="text" class="form-control sectorform required"  readonly="readonly" data-msg-required="${subSectorReq}" />
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="sectorPlotNumber" id="plotnumber" name="plotnumber" type="text" class="form-control sectorform required "  readonly="readonly" data-msg-required="${plotNoReq}"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
		                                        	...
		                                        	<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																<form:input path="areaBlock"  type="text" id="area-block" name="area-block" class="form-control areaform required" readonly="readonly" data-msg-required="${blockReq}"/>
			                                                </div>
		                                            	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="subArea" id="sub-area" name="sub-area" type="text" class="form-control areaform required " readonly="readonly" data-msg-required="${subAreaReq}"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>												
													<div class="col-md-6 remove-pad">
		                                            	...
		                                            	<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7"> 
			                                                    <form:input path="areaPlotNumber" id="area-plotnumber" name="area-plotnumber" type="text" class="form-control areaform required" readonly="readonly" data-msg-required="${plotNoReq}"/>
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
