			...
			if (logininfo != null) {
				...
				try {
					...
					if (purchaseId != null && !purchaseId.isEmpty()) {
						...
						// requestNo, statusId
						paymentStatus = purchaseService.getPaymentInfo(purchaseId);
					...
					/*	returnUrl = returnUrl + "&statusId=" + paymentStatus.getStatusId() 
						...
						inquiryPaymentResponse = purchaseService.getSuccessfulPaymentTransaction(purchaseId);
						...
						model.addAttribute("generalFee",purchaseService.getGeneralFee());
					}
				} catch (Exception e) {
