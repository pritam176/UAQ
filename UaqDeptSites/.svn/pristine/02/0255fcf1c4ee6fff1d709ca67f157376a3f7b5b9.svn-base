...
<table width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="3%"><form:select path="mobile1" style="width:40px"><option value="">050</option>
    </form:select>    </td>
    <td width="25%"><form:input type="text" path="mobile1Path" style="width:130px"/></td>
    <td height="40"><b>Mobile 2</b></td>
    <td><form:select path="mobile2"><option value="">050</option>
    </form:select>
      <form:input type="text" path="mobile2Path" style="width:130px" /></td>
  </tr>
  <tr>
    <td height="40"><b>LandLine</b></td>
    <td><form:select path="landLine"><option value="">06</option></form:select></td>
    <td><form:input type="text" path="landLinePath" style="width:130px"/></td>
    <td colspan="2">&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><form:input type="text" path="emirateId" /><img src="Help-icon.png" alt="symbol" height="20" width="20"></td>
    <td><b>Emirated ID Expiry Date</b><label class="test">*</label></td>
    <td><form:select path="emirateIdExpiryDate" style="width:170px"><option value="">10/06/2014</option></form:select></td>
  </tr>
  <tr>
    <td height="40"><b>Emirate</b><label class="test">*</label></td>
    <td colspan="4"><form:select path="emirate" style="width:170px"><option value="">Umm Al Quwain</option>
    </form:select>    </td>
    </tr>
  <tr>
    <td height="40"><b>DOB</b><label class="test">*</label></td>
    <td colspan="4"><form:select path="dob" style="width:170px"><option value="">10/06/1995</option></form:select><img src="Help-icon.png" alt="symbol" height="20" width="20"></td>
    </tr>
  <tr>
    <td height="40"><b>Emirate ID Front</b></td>
    <td colspan="2"><form:input type="file" path="file[0]" /></td>
  ...
  <tr>
    <td height="40"><b>Full Name</b><font size="1">(as stated in the passport)</font><label class="test">*</label></td>
    <td height="40" colspan="4"><form:input type="text" path="fullName"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="40" colspan="4"><form:input type="file" path="file[2]"/>    </tr>
</table>
<br/><br/>
        <%--  <Center>	<%
   ...
   <p class="newSignupSubmit1"> <input type="checkbox" name="newsletter"/><font size="1.5">Subscribe to receive letter</font></p>
