												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
			                                                <div class="col-md-5">
			                                                    <label for="plan-number" class="form-lbl "><spring:message code="label.ps.siteplanNo" /> <span class="form-lbl-subtxt"> 	</span>
			                                                    </label>
				                                            </div>
				                                            <div class="col-md-7">
															...
															<div class="col-md-7">
																	...
																	<div class="custom-select-box cf">
																		<form:select path="landUsage" class="required1 required"
																			id="area-select1" name="landUsage"  data-msg-required="${landUsageReq}">
																			<form:option value=""><spring:message code="option.select"/> </form:option> 
