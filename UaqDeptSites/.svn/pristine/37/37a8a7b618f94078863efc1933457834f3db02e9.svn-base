...
@Repository(value = "contentReferneceDAO")
public class ContentReferneceDAO implements GenericDao<NavigationVO, NavigationVO> {

	protected static UAQLogger logger = new UAQLogger(ContentReferneceDAO.class);
	...
	public NavigationVO findByPrimaryKey(NavigationVO navigationVO) throws UAQException {
		...
		//TODO: will revisit below check.
		if(siteName == null){
			siteName = navigationVO.getSite();
		}
