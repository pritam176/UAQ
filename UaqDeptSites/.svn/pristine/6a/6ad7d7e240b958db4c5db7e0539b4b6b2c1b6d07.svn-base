	...
	<form:form>
		...
		<table width="62%" cellspacing="5">
			<tr>
				...
				<td width="28%"><form:input path="" type="text" name="eName"
			...
			<tr>
				...
				<td width="28%"><form:select path="" style="width: 150px;">
			...
			<tr>
				<td width="21%"><label>Trade License Number</label></td>
				<td width="28%"><form:input path="" type="text" value=""
						style="width: 150px;" /></td>
				<td width="30%"><label>Trade License Expiry Date</label></td>
			...
			<tr>
				<td width="21%"><label>Trade License Type</label></td>
				<td width="28%"><form:select path="" style="width: 150px;">
						<option value="1/05/2020">1/05/2020</option>
					</form:select></td>
			</tr>
			...
			<tr>
				<td width="21%"><label>Signatories Attestation</label></td>
				<td width="28%"><form:input path="" type="file"
						style="width: 150px;" /></td>
			</tr>
		...
		<br>
		<table width="62%" height="56">
			<tr>
				<td width="21%" height="26"><label>Username</label></td>
				<td width="28%"><form:input path="" type="text" name="uname"
						style="width: 150px;" />
			</tr>

			<tr>
				<td width="21%" height="26"><label>Password</label></td>
