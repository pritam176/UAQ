					...
					<div class="col-md-12 hidden-xs hidden-sm">
						<div class="mainmenu-wrap">
							<ul class="no-list cf">
								...
								<li class="active"><a href="#"><spring:message code="label.ps.grantlandreq" /></a>
								</li>
							...
							<div class="page-title-wrap">
								<div class="row">
									<div class="col-xs-12 col-sm-9 col-md-10 title-txt">
										...
										<h2 class="page-title">
									<spring:message code="label.ps.grantlandreq" />
										</h2>
										<!-- /page title -->
									</div>
							...
							<div class="main-content-wrap">
								...
								<div class="page-content-wrap">
										<div class="form-content cf">
										   <form:form commandName="grantLandRequestCommand" name="feedbak" id="feedbak" enctype="multipart/form-data" method="post" action="resubmitgrantlandrequest.html" >
										    <div class="row"></div>	
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																	<form:input path="familyMembers" id="plan-number" name="plan-number" type="text"  class="form-control" data-msg-required="${familyReq}" />
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
												...
												<div class="col-md-12 remove-pad">
													<div class="col-md-6 remove-pad">
														...
														<div class="form-group cf">
				                                            ...
				                                            <div class="col-md-7">
																	<form:input path="monthlySalary" id="salary" name="salary" type="text"  class="form-control required" data-msg-required="${salaryReq}"  />
			                                                </div>
		                                            	</div>
		                                        		<!-- /text box -->
		                                        	</div>
																...
																<div class="input-group file-upload">
																	...
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			...
																			<form:input path="familyBook" type="file" multiple="multiple"/>
																		</span>
																	</span>
																</div>
			                                                </div>
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	...
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<form:input path="spousesEmiratesIdAttch" type="file" multiple="multiple"/>
																		</span>
																	</span>
																</div>
			                                                </div>
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	...
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<form:input path="propertyAccDetailsAttach" type="file" multiple="multiple"/>
																		</span>
																	</span>
																</div>
			                                                </div>
				                                            ...
				                                            <div class="col-md-7">
																<div class="input-group file-upload">
																	...
																	<span class="input-group-btn">
																		<span class="btn btn-file">
																			<spring:message code="file.browse" />&hellip; 
																			<form:input path="salaryCertificate" type="file" multiple="multiple"/>
																		</span>
																	</span>
																</div>
			                                                </div>
