    ...
    $.fn.lightGallery = function (options) {
        ...
        var setUp = {
            ...
            buildThumbnail: function () {
                if (settings.thumbnail === true && $children.length > 1) {console.log('s');
                    var $this = this,
                        $close = '';
            ...
            slide: function (index) {
                ...
                if (settings.thumbnail === true && $children.length > 1) {
					...
					$("#lg-slider").removeClass("lg-sliderOne");
					$("#lg-gallery").removeClass("lg-galleryOne");
                }else{
					$("#lg-slider").addClass("lg-sliderOne");
					$("#lg-gallery").addClass("lg-galleryOne");
				}
